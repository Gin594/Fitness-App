...
public class TeamMemberDeletTest {
    ...
    @Test
    public void teamMemberDeletTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.teamMemberListCellTitle), withText("Tianpeng Fan"),
                        childAtPosition(
                                withParent(withId(R.id.team_fragment_listView)),
                                0),
                        isDisplayed()));
